    ...
    <div class="card bg-light mt-4">
        <legend class="card-header">
            <div class="d-flex justify-content-between">
                <div class="h5"><strong>Datensatz <?= $todo == 2 ? ' löschen' : ' neu erstellen'?></strong></div>
            ...
            <form action="<?= base_url('Mitglieder/submit_edit') ?>" method="post">
                ...
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input <? if($todo == 2) : ?>disabled='disabled'<? endif ?> type="text" class="form-control <?=(isset($error['username']))?'is-invalid':'' ?>" id="username" name="username" placeholder="username"
                ...
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-10">
                        <input <? if($todo == 2) : ?>disabled='disabled'<? endif ?> type="email" class="form-control <?=(isset($error['email']))?'is-invalid':'' ?>" id="email" name="email" placeholder="email"
                               value="<?=isset($mitglieder['email']) ? $mitglieder['email'] : '' ?>">
                        <div class="invalid-feedback">
                ...
                <div <? if(session()->get('id') != $mitglieder['id']) : ?>style="visibility: hidden"<? endif ?> class="form-group row mb-2">
                    ...
                    <div class="col-sm-10">
                        <input <? if($todo == 2) : ?>disabled='disabled'<? endif ?> type="password" class="form-control <?=(isset($error['passwort']))?'is-invalid':'' ?>" id="passwort" name="passwort" placeholder="passwort"
                               value="<?=isset($mitglieder['passwort']) ? $mitglieder['passwort'] : '' ?>">
                        <div class="invalid-feedback">
